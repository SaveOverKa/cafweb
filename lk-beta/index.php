...
<title>Careera Next  - My resume</title>
...
<body>
	...
	<div id="page">
		...
		<div id="header" class="clearfix">
			...
			<ul id="main-nav">
				<li class="current"><a href="index.php">Моя страница</a></li>
		...
		<div class="content-innertube">
			...
			<div id="content-left">
				...
				<div class="section">
					...
					<div class="clearfix"><h2>Анкета</h2></div>
					
					<div class="item">
					
						<ul id="personal-details">
							<li><span>Имя:</span>John William Doe</li>
							<li><span>День рождения:</span>July 27, 1989</li>
							<li class="clearfix"><span>Адрес:</span>
								<ul id="address-lines">
							...
							<li><span>Телефона:</span>0 123 456 789</li>
